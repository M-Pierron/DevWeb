...
function Home() {
  return (
    <div className="flex flex-col w-dvw h-dvh">
      <Nav name={"ACCUEIL"}/>
      <div className="flex flex-row size-full bg-[url(src/assets/wallpaperHome.png)] bg-no-repeat bg-center bg-cover h-full p-4">
      ...
      <div className="flex flex-col bg-[#3c5497] w-full h-full border-t-black border-t-2">
